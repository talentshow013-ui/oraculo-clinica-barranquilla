...
const RUTAS = [['/panel', 'Centro de mando'], ['/diagnostico', 'Diagnóstico'], ['/oportunidades', 'Oportunidades'], ['/embudo', 'Embudo'], ['/rendimiento', 'Rendimiento'], ['/creativos', 'Creativos'], ['/audiencias', 'Audiencias'], ['/competencia', 'Radar de mercado'], ['/biblioteca', 'Banco de mensajes'], ['/consejo', 'Mesa de consultores'], ['/metricas', 'Catálogo de métricas'], ['/informe', 'Informe'], ['/fuentes', 'Fuentes']]
