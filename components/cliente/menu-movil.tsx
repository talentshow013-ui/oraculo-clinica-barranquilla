...
const RUTAS = {
  ...
  google: [['/web', 'Resumen'], ['/web#canales', 'Canales y fuentes'], ['/web#paginas', 'Páginas que convierten'], ['/web#eventos', 'Contactos (eventos clave)'], ['/web#ciudades', 'Ciudades'], ['/web#fuente', 'Fuente']],
} as const
const FONDO = { pauta: 'bg-marino', organico: 'bg-marino-org', google: 'bg-marino-goo' } as const
