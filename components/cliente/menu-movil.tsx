...
const RUTAS = [['/panel', 'Centro de mando'], ['/diagnostico', 'Diagnóstico'], ['/oportunidades', 'Oportunidades'], ['/embudo', 'Embudo'], ['/rendimiento', 'Rendimiento'], ['/campanas', 'Campañas'], ['/creativos', 'Creativos'], ['/audiencias', 'Audiencias'], ['/competencia', 'Radar de mercado'], ['/biblioteca', 'Copys exitosos'], ['/consejo', 'Mesa de consultores'], ['/metricas', 'Catálogo de métricas'], ['/informe', 'Informe'], ['/fuentes', 'Fuentes']]
