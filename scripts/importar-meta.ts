...
console.log(`  archivos: ${resumen.archivos} · filas leídas: ${resumen.filasLeidas} · insights: ${resumen.insights} · desgloses: ${resumen.desgloses} · creativos: ${resumen.creativos} · rankings de Meta: ${resumen.rankings} · cambios en bitácora: ${resumen.bitacora}`);
